...
zero-native can configure native app menus from typed Zig data. Menu items dispatch through the same command path as shortcuts, native controls, tray actions, and bridge commands.
